...
public class MoneyUtils {
	 ...
	 * 数值与中文数字映射关系
	 */
	private static final Map<String, String> numberMap = new HashMap<>(16);

	/**
	 * 长度与单位映射关系
	 */
	private static final Map<Integer, String> unitMap = new HashMap<>(16);

	/**
	 * 从后往前数，每8个为单位，获取单位数值，千，百，十，万，千，百，十，一
	 */
	private static final Map<Integer, String> unitMap4Digits = new HashMap<>(16);
